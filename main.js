...
const createElement = (html, className) => {
  ...
  //oluşturduğumuz divi içerisine dışarıdan gelen parametreyi html parametresi olarak ekler
...
const handleOutGoingChat = () => {
  userText = chatInput.value.trim(); //inputun içerisindeki değeri alıp fazladan boşlukları siler(trim)
  ...
  `;
  //kullanıcının yadığı veriye göre bir div olşturur ve bunu chat-container yapısına ekler
